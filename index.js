...
var oscServer = new osc.Server(9000, '0.0.0.0');
   ...
   oscServer.on("message", function (msg, rinfo) {
      console.log("message");
        if(msg[2][0]=="/updatePeopleInside"){
          peopleInside =Math.max(peopleInside+msg[2][1],0);
    ...
    function updatePeopleInside(){
        ...
        myTween.stop().to({bright:b},500).start();
        io.sockets.emit('message',{ content: 'peopleInside', val: peopleInside });
    }
});
